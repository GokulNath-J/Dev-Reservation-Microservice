...
public class ServiceClass {
        ...
        for (int i = 0; i < totalStations; i++) {
            ...
            for (TrainCoaches trainCoach : trainCoaches) {
                ...
                for (String bookingname : bookingtype) {
                    TicketsPerStation ticketsPerStations = new TicketsPerStation(bookingname, train_number, trainCoach.getCoach_name(), divideTicketsPerStation, trainCoach.getEach_seat_price());
    ...
    public void bookTicket(Integer trainNumber, String coach, List<String> passengers_name,Integer noOfTickets, Integer amount,
